            ...
            .collect {
                ...
                if (it.isFullMuted()) {
                    ...
                    when {
                            ...
                            logger.info("User ${member.username} would have been disconnected after of ${(ROUNDS_BEFORE_KICKING * executionDelaySeconds)/60} minutes being fully muted.")
//                            member.disconnect()
                        }
